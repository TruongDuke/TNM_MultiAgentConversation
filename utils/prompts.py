...
# Định nghĩa TNM rút gọn cho ung thư phổi
...
def get_doc_system_message(
    ...
    msg = (
        ...
        "    - If distant organ metastasis (e.g., liver, adrenal, bone, brain) or non-regional lymph nodes is present, you MUST choose M1.\n"
        "    - If no distant metastasis is described, you MUST choose M0.\n\n"
        "Key responsibilities:\n"
        "    1. Explicitly extract and state:\n"
        "        - Tumor size (in cm) if mentioned.\n"
        "        - Which lymph node regions are involved (ipsilateral/contralateral, hilar/mediastinal/scalene/supraclavicular).\n"
        "        - Whether there is any distant metastasis.\n"
...
def get_supervisor_system_message(
    ...
    msg = (
        ...
        "    - If distant organ metastasis (e.g., liver, adrenal, bone, brain) or non-regional lymph nodes is present, you MUST set M = 1.\n"
        "    - If no distant metastasis is described, you MUST set M = 0.\n\n"
        "Key tasks:\n"
        ...
        "        * \"T\": integer or null (e.g., 3 or 4)\n"
        "        * \"N\": integer or null (e.g., 2 or 3)\n"
...
def get_evaluate_prompts():
    """
    Không dùng cho TNM hiện tại, trả về 3 template rỗng để tránh lỗi import.
    """
    MOST = ""
    POSSI = ""
    ROM_T = ""
